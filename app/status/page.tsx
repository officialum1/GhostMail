        ...
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                href="/register"
                className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-cyan-400 to-blue-500 px-5 py-3 font-semibold text-white"
              >
                Create inbox
              ...
              <Link
                href="/contact"
                className="inline-flex items-center rounded-xl border border-white/10 px-5 py-3 font-semibold text-white transition hover:bg-white/5"
              >
                Contact support
              </Link>
            </div>
          ...
          <div className="rounded-[28px] border border-white/10 bg-[#0f1627] p-6 shadow-[0_32px_80px_rgba(0,0,0,0.3)]">
            <div className="flex items-center justify-between gap-4 border-b border-white/10 pb-5">
              <div>
                <p className="text-sm font-semibold uppercase text-cyan-300">
                  Current health
                </p>
                <h2 className="mt-2 text-2xl font-semibold text-white">Operational</h2>
              </div>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        <div className="grid gap-6 lg:grid-cols-3">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            ...
            <h2 className="mt-5 text-xl font-semibold text-white">Recent incidents</h2>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            ...
            <h2 className="mt-5 text-xl font-semibold text-white">Delivery monitor</h2>
            <p className="mt-3 text-sm leading-6 text-slate-400">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            ...
            <h2 className="mt-5 text-xl font-semibold text-white">Security contact</h2>
            <p className="mt-3 text-sm leading-6 text-slate-400">
