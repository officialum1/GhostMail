      ...
      <section className="mx-auto max-w-6xl px-6 py-20 md:py-32">
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-2">
          <div className="rounded-[32px] border border-cyan-400/20 bg-[linear-gradient(180deg,rgba(34,211,238,0.12),rgba(255,255,255,0.04))] p-8 backdrop-blur">
            ...
            <h2 className="mt-4 text-3xl font-bold text-slate-900 dark:text-white">Free Forever</h2>
            <p className="mt-3 text-5xl font-bold text-slate-900 dark:text-white">$0</p>
          ...
          <div className="rounded-[32px] border border-slate-200 dark:border-white/10 bg-slate-100 dark:bg-white/5 p-8 backdrop-blur">
            <p className="text-sm uppercase tracking-[0.3em] text-slate-500 dark:text-slate-400">Coming later</p>
            <h2 className="mt-4 text-3xl font-bold text-slate-900 dark:text-white">Power features</h2>
