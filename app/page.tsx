  ...
  return (
    <PageLayout>
      <div className="bg-[#0a0f1e]">
        ...
        <section className="mx-auto max-w-7xl px-6 py-20 md:py-28">
          <div className="grid gap-8 rounded-[28px] border border-white/10 bg-[#0e1728] p-8 md:p-10 lg:grid-cols-[1fr_420px] lg:items-center">
            <div>
        ...
        <section className="mx-auto max-w-7xl px-6 py-20 md:py-28">
          <div className="grid gap-5 md:grid-cols-3">
            {testimonials.map((item) => (
              <div key={item.author} className="rounded-2xl border border-white/10 bg-[#0e1728] p-6">
